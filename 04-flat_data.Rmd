...
We'll start with a csv file which is among the most common types. 
...
hsb<-read_csv(file="http://www.ats.ucla.edu/stat/r/modules/hsb2.csv")
...
write.fwf(data.frame(hsb),file="hsb.dat",sep="",colnames=FALSE)
...
gs1<-read_dta("http://www.ats.ucla.edu/stat/stata/dae/binary.dta")

head(gs1)


#SPSS
gs2<-read_spss("http://www.ats.ucla.edu/stat/data/binary.sav")
...
gs3<-read_sas("http://www.ats.ucla.edu/stat/sas/dae/binary.sas7bdat")
...
write_csv(free2,file="frl.csv",sep=",")
```
